...
urlpatterns=[
    ...
    path('birth_certificate_pdf/<str:birth_number>/', views.BirthCertificateView.as_view(), name='generate-birth-pdf'),
    path('death_certificate_pdf/<str:death_number>/', views.DeathCertificateView.as_view(), name='generate-death-pdf'),
    ...
    path('birth_certificate/<str:birth_number>/', views.BirthCertificateView.as_view(), name='birth-certificate'),
    path('death_certificate/<str:death_number>/', views.DeathCertificateView.as_view(), name='death-certificate'),
